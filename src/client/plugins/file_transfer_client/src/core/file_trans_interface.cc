...
void FileTransInterface::OnProtoMessage(const std::string& msg_str) {
	// to do
    LOGI("OnMessage: {}", msg_str);
...
void FileTransInterface::OnClickedFileTrans() {
