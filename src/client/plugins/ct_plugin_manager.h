...
namespace tc
{
    ...
    public:
        static std::shared_ptr<ClientPluginManager> Make(const std::shared_ptr<ClientContext>& ctx);

        explicit ClientPluginManager(const std::shared_ptr<ClientContext>& ctx);
